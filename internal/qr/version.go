// Derived from github.com/skip2/go-qrcode/version.go (MIT License).
// Copyright (c) 2014 Tom Harwood. See THIRD_PARTY_NOTICES in the repo root.
//
// Original: https://github.com/skip2/go-qrcode
// Modifications: extracted into internal package, replaced bitset import
// with package-local type.

package qr

import "log"

// RecoveryLevel is the QR Code error recovery capacity.
type RecoveryLevel int

const (
	// Low provides 7% error recovery (Level L).
	Low RecoveryLevel = iota

	// Medium provides 15% error recovery (Level M). Good default choice.
	Medium

	// High provides 25% error recovery (Level Q).
	High

	// Highest provides 30% error recovery (Level H).
	Highest
)
...
func (v qrCodeVersion) versionInfo() *bitset {
	...
	result := newBitset()
	result.appendUint32(versionBitSequence[v.version], versionInfoLengthBits)
