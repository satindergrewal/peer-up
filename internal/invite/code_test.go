...
func TestEncodeDecodeRoundTrip(t *testing.T) {
	...
	data := &InviteData{
		Token:     token,
		RelayAddr: "/ip4/192.53.169.150/tcp/7777/p2p/12D3KooWRzaGMTqQbRHNMZkAYj8ALUXoK99qSjhiFLanDoVWK9An",
		PeerID:    pid,
	}
...
func TestDecodeRejectsTrailingJunk(t *testing.T) {
	...
	data := &InviteData{
		Token:     token,
		RelayAddr: "/ip4/192.53.169.150/tcp/7777/p2p/12D3KooWGeHBFwr7xKPVTd3dCCJ751Qgeij83rQaZvGAHwnVFRuA",
		PeerID:    pid,
	}
