...
**Context**: The invite code format needs to evolve to include the DHT namespace and support the PAKE handshake. Existing v1 invite codes (generated by older peerup versions) should still work.
...
**Reference**: `internal/invite/code.go`, `cmd/peerup/cmd_invite.go`, `cmd/peerup/cmd_join.go`
