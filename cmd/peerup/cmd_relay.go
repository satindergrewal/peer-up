...
func printRelayUsage() {
	...
	fmt.Println("  peerup relay add /ip4/192.53.169.150/tcp/7777/p2p/12D3KooW...")
	fmt.Println("  peerup relay add 192.53.169.150:7777 --peer-id 12D3KooW...")
	fmt.Println("  peerup relay add 192.53.169.150 --peer-id 12D3KooW...  (default port: 7777)")
	fmt.Println("  peerup relay list")
	fmt.Println("  peerup relay remove /ip4/192.53.169.150/tcp/7777/p2p/12D3KooW...")
	fmt.Println()
