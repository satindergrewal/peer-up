...
func TestParseRelayHostPort(t *testing.T) {
	tests := []struct {
		...
		// IPv4
		{"ipv4 with port", "192.53.169.150:7777", "192.53.169.150", 7777, false},
		{"ipv4 bare", "192.53.169.150", "192.53.169.150", 7777, false},
...
func TestBuildRelayMultiaddr(t *testing.T) {
	tests := []struct {
		...
		{"192.53.169.150", 7777, "12D3KooWTest", "/ip4/192.53.169.150/tcp/7777/p2p/12D3KooWTest"},
...
func TestIsFullMultiaddr(t *testing.T) {
	...
	if isFullMultiaddr("192.53.169.150:7777") {
