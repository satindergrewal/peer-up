...
{{< hextra/hero-headline >}}
  Access your home server&nbsp;<br class="sm:block hidden" />from anywhere
{{< /hextra/hero-headline >}}
</div>

<div class="hx-mb-12">
{{< hextra/hero-subtitle >}}
  Peer-to-peer connectivity that works through NAT, CGNAT, and firewalls.&nbsp;<br class="sm:block hidden" />No accounts. No cloud. No trust required.
{{< /hextra/hero-subtitle >}}
</div>
